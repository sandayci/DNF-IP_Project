...
#ifndef NEURAL_FIELD_IP_H
#define NEURAL_FIELD_IP_H
 ...
 */
class NeuralField_IP : public cedar::dyn::Dynamics
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
...
protected:
  ...
  //!@brief this SpaceCode matrix contains the current field activity of the NeuralField including IP parameters
  cedar::aux::MatDataPtr mActivationIP;
  ...
  //!@brief learn rate of the IP adaptation
  cedar::aux::DoubleParameterPtr mLearnRateIP;
  
  //!@brief mean of the desired IP exponential distribution
  cedar::aux::DoubleParameterPtr mMuIP;

  //!@brief this SpaceCode matrix contains the current Gain IP parameter
  cedar::aux::MatDataPtr mGainIP;

  //!@brief this SpaceCode matrix contains the current Bias IP parameter
  cedar::aux::MatDataPtr mBiasIP;

  //!@brief this SpaceCode matrix contains the current Tensor estimate
  cedar::aux::MatDataPtr mTensorIP;
...
private:
  cv::Mat IP_regul;  // regularization term for tensor inversion
  cv::Mat IP_theta;  // temporal storage of delta_gain and delta_bias
  cv::Mat IP_theta_F;  // temporal storage of delta_gain and delta_bias in Rieman space
  
}; // class NeuralField_IP
